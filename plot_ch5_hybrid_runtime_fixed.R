# ============================================================
# Chapter 5 plotting script for runtime-fixed results
# ============================================================
...
shape_values_5 <- c("Uniform" = 16, "Random" = 17, "SA" = 15, "SH" = 3, "Hybrid" = 7)
shape_values_7 <- c("SH_full" = 16, "SA_full" = 17, "Hybrid" = 15,
                    "SH_half" = 3, "SA_random_half" = 7,
                    "SA_from_SH_half" = 8, "Hybrid_restricted" = 4)

# ------------------------------------------------------------
# Main comparison with Hybrid
# ------------------------------------------------------------
...
if (file.exists(lam_file)) {
  ...
  p_lam <- ggplot(lam_sum,
    ...
    geom_point(size = 2.5, na.rm = TRUE) +
    facet_wrap(~ theta_set_size, nrow = 1) +
    labs(x = expression(lambda), y = "Mean valid power",
